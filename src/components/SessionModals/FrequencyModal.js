...
export default function FrequencyModal({
  ...
  const getPercentage = (value) => {
    console.log(rate);
    const res = rate[value].percentage * 100 || 0;
      ...
      <View>
        ...
        <View style={{ marginTop: 22 }}>
          ...
          <Text style={styles.text}>
            % of <Text style={{ color: COLORS.red }}> incorrect </Text>{" "}
            responses: {getPercentage("wrong")}
          </Text>
          <Text style={styles.text}>
            % of <Text style={{ color: COLORS.mediumGray }}> neutral </Text>
            responses: {getPercentage("neutral")}
          </Text>
          <Text style={styles.text}>
            % of <Text style={{ color: COLORS.green }}> correct </Text>{" "}
